...
var readLine = function () { return __awaiter(_this, void 0, void 0, function () {
    var input;
...
var promptInput = function (text) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        printLine("\n" + text + "\n> ", false);
        return [2 /*return*/, readLine()];
    });
}); };
var promptSelect = function (text, values) { return __awaiter(_this, void 0, void 0, function () {
    var input;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
